...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="pt-24 min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 bg-white/60 backdrop-blur-sm rounded-xl p-8 border border-gray-100 shadow-sm max-w-5xl mx-auto">
