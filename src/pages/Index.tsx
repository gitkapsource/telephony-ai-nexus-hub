...
const Index = () => {
  const seoData = {
    ...
    pageDescription: "Leading VoIP and Voice AI solutions provider. Expert IP Telephony, Voice Bots, Chat Bots, SIP Trunking, PBX Systems, FreeSWITCH, Asterisk, Amazon Connect, 3CX, Twilio consulting.",
    keywords: [
      "VoIP Services ",
      "Voice AI Solutions",
